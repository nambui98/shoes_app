...
import 'package:shoes_app/pages/details_shoes.dart';
                          ...
                          child: LayoutBuilder(builder: (context, snapshot) {
                            return AnimatedContainer(
                              ...
                              child: Stack(clipBehavior: Clip.none, children: [
                                ...
                                Positioned(
                                    top: snapshot.maxHeight * 0.2,
                                    left: snapshot.maxWidth * 0.05,
                                    right: -snapshot.maxWidth * 0.16,
                                    bottom: snapshot.maxHeight * 0.2,
                                    child: Hero(
                                      tag: shoes.name,
                                      child: Image(
                                          image: AssetImage(
